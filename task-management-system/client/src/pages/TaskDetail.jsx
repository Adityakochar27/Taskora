...
export default function TaskDetail() {
  ...
  // ─── Permission flags (mirror server-side rules) ───
  ...
  // Forward = move to a "later" status. Only the assignee can do this
  // (or admin override).
  const canMoveForward = isAssignee || isAdmin;
  // Backward = revert. Only assigner or admin.
  const canMoveBackward = isAssigner || isAdmin;
  // Delegate: assignee, original assignee, assigner, or admin.
  const canDelegate =
    !!task.assignedToUser &&
